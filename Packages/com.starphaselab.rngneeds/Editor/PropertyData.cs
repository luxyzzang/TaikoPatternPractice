...
namespace RNGNeeds.Editor
{
    ...
    internal class PropertyData
    {
        ...
        public GenericMenu DrawerDisplayOptionsDropdownMenu;
        ...
        public float NumericPropertyFieldOffset;
        public string NumericPropertyLabelText;
        ...
        {
            stripeIndexStyle.fontSize = PLDrawerTheme.stripeInfoFontSize;
            ...
            stripeNameStyle.fontSize = PLDrawerTheme.stripeInfoFontSize;
