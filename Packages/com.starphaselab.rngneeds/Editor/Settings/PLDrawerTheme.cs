...
namespace RNGNeeds.Editor
{
    internal static class PLDrawerTheme
    {
        ...
        private static Texture2D DisplayOptionsDropdownButtonTexture { get; set; }
        private static Texture2D DisplayOptionsDropdownButtonHoverTexture { get; set; }
        ...
        internal static Texture2D StripeWeightsIconTexture { get; set; }
        ...
        public static readonly GUIStyle AddButtonHighlight;
        ...
        public static readonly GUIStyle DisplayOptionsDropdownButton;
        ...
        public const int standardFontSize = 11;
        public const int stripeInfoFontSize = 11;
        ...
        static PLDrawerTheme()
        {
            ...
            DisplayOptionsDropdownButtonTexture = LoadTexture(EditorGUIUtility.isProSkin ? "PL_DisplayOptionsDropdownButton_00000" : "PL_DisplayOptionsDropdownButton_00000");
            DisplayOptionsDropdownButtonHoverTexture = LoadTexture(EditorGUIUtility.isProSkin ? "PL_DisplayOptionsDropdownButtonHover_00000" : "PL_DisplayOptionsDropdownButtonHover_00000");
            ...
            StripeWeightsIconTexture = LoadTexture(EditorGUIUtility.isProSkin ? "PL_StripeWeightsIcon_00000" : "PL_StripeWeightsIcon_00000");
            ...
            AdvancedOptionsLabelStyle = new GUIStyle() { fontSize = 11, normal = { textColor = new Color(.8f, .8f, .8f, 1f) }, alignment = TextAnchor.MiddleLeft};
            ...
            PropertyNameStyle = new GUIStyle() { alignment = TextAnchor.MiddleRight, padding = new RectOffset(0, 60, 0, 0), fontSize = standardFontSize, fontStyle = FontStyle.Bold, normal = { textColor = EditorGUIUtility.isProSkin ? new Color(.8f, .8f, .8f, 1f) : new Color(.9f, .9f, .9f, 1f) } };
            CollectionPropertyNameStyle = new GUIStyle() { alignment = TextAnchor.MiddleCenter, fontSize = 12, fontStyle = FontStyle.Bold, normal = { textColor = EditorGUIUtility.isProSkin ? new Color(.8f, .8f, .8f, 1f) : new Color(.9f, .9f, .9f, 1f) } };
            ...
            HideEntriesButtonOn = new GUIStyle(OptionButtonOn) { fontSize = 12 };
            ...
            DisplayOptionsDropdownButton = new GUIStyle() { normal = { background = DisplayOptionsDropdownButtonTexture }, hover = { background = DisplayOptionsDropdownButtonHoverTexture }, active = { background = DisplayOptionsDropdownButtonHoverTexture } };
            ...
            AddButton = new GUIStyle(SectionButtonOn) { fontSize = 12 };
            AddButtonHighlight = new GUIStyle(OptionButtonOn) { fontSize = 12 };
            ...
            InputField = new GUIStyle() { fontSize = standardFontSize, normal = { background = InputFieldTexture, textColor = Color.white }, border = new RectOffset(8, 8, 8, 8), alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Bold, };
