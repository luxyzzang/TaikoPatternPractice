...
namespace RNGNeeds.Editor
{
    public class RNGNeedsSettingsProvider : SettingsProvider
    {
        ...
        private SerializedProperty p_DrawerSectionButtons;
        private SerializedProperty p_DrawerDisplayOptionsButtons;
        ...
        private class Styles
        {
            ...
            public static GUIContent DrawerSectionButtons = new GUIContent(nameof(RNGNeedsSettings.DrawerSectionButtons));
            public static GUIContent DrawerDisplayOptionsButtons = new GUIContent(nameof(RNGNeedsSettings.DrawerDisplayOptionsButtons));
        ...
        public override void OnActivate(string searchContext, VisualElement rootElement)
        {
            ...
            p_DrawerSectionButtons = m_SerializedObject.FindProperty("m_DrawerSectionButtons");
            p_DrawerDisplayOptionsButtons = m_SerializedObject.FindProperty("m_DrawerDisplayOptionsButtons");
        ...
        public override void OnGUI(string searchContext)
        {
            using (CreateSettingsWindowGUIScope())
            {
                ...
                using (var check = new EditorGUI.ChangeCheckScope())
                {
                    ...
                    EditorGUILayout.PropertyField(p_DrawerSectionButtons);
                    EditorGUILayout.PropertyField(p_DrawerDisplayOptionsButtons);
