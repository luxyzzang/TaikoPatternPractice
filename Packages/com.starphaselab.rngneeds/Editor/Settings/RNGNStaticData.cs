...
namespace RNGNeeds.Editor
{
    internal static class RNGNStaticData
    {
        ...
        public const string ImportPalettesWindowTitle = "Import Palettes?";
        public const string ImportPalettesWindowText = "Choose whether to add new palettes from XML to the existing list or replace the existing list of palettes with those found in XML.";
        public const string ImportPalettesWindowConfirm = "Add New Palettes";
        public const string ImportPalettesWindowConfirmReplace = "Replace Existing List";
        ...
        public const string OverwritePalettesWindowConfirm = "Replace Palettes";
