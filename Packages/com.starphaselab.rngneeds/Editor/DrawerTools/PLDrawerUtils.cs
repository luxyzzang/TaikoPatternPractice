...
namespace RNGNeeds.Editor
{
    internal static class PLDrawerUtils
    {
        ...
        public static GUIContent GetThemeSectionButtonContent(DrawerSectionButtons drawerSectionButtons, PLDrawerSettings drawerSettings)
        {
            switch (drawerSectionButtons)
            {
                case DrawerSectionButtons.Compact:
                ...
                case DrawerSectionButtons.Full:
                    return PLDrawerContents.ThemeSectionButton;
                case DrawerSectionButtons.Informative:
                    ...
                    return ThemeButtonTempContent;
                default:
                    throw new ArgumentOutOfRangeException(nameof(drawerSectionButtons), drawerSectionButtons, null);
            }
        }

        public static GUIContent GetPickSectionButtonContent(DrawerSectionButtons drawerSectionButtons, PropertyData propertyData)
        {
            switch (drawerSectionButtons)
            {
                case DrawerSectionButtons.Compact:
